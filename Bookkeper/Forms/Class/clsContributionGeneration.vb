...
#Region "Class ContribtuionGeneration Public Functions"
        ...
        Public Function Save_Generated_Contribution_Record() As Boolean
            Try
                ...
                strSql = "CALL spMemberContributionGeneratedSave('" & memberNo & "','" & memberName & "'," & memberFl & ",'" & contributionDt & "'," & updatedBy & ");"
        ...
        Public Function Populate_Member_Contribution_List_Report(ByVal conDt As String, ByVal memNo As String, ByVal memName As String, ByVal activeFl As Integer) As DataTable
            ...
            Try
                With clsDataAccess
                    ...
                    strSql = "CALL spMemberContributionDetailReport('" & conDt & "','" & memNo & "','" & memName & "'," & activeFl & ");"
        ...
        Public Function Populate_Member_Contribution_List_Record(ByVal conDt As String, ByVal memNo As String, ByVal memName As String, ByVal activeFl As Integer) As DataTable
            Dim clsDataAccess As New DataAccess.DataAccess(gConnStringFileName)
            Dim strSql As String
            Dim dtListView As DataTable
            Try
                With clsDataAccess
                    dtListView = New DataTable
                    strSql = "CALL spMemberContributionListFind('" & conDt & "','" & memNo & "','" & memName & "'," & activeFl & ");"
