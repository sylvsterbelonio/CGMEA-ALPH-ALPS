...
#Region "Class Loan Application Public Functions"
        ...
        Public Function RebatesGet(ByVal lId As Integer, ByVal mId As Integer, ByVal orDt As String) As Double
            Dim sqlStmt As String

            Try
                sqlStmt = "CALL spLoanRebatesGet(" & lId & "," & mId & ",'" & orDt & "');"
                dtRecord = clsDataAccess.ExecuteQuery(sqlStmt, False, RETURN_TYPE_DATATABLE)
        ...
        Public Function RebatesGet1() As String
            Try
                Return "Hello"
            Catch ex As MySqlException
                RaiseEvent MsgArrival(ex.Message, False)
        ...
        Public Function CISPUnusedGet(ByVal lId As Integer, ByVal mId As Integer, ByVal orDt As String) As Double
            Dim sqlStmt As String

            Try
                sqlStmt = "CALL spLoanCISPUnusedGet(" & lId & "," & mId & ",'" & orDt & "');"
                dtRecord = clsDataAccess.ExecuteQuery(sqlStmt, False, RETURN_TYPE_DATATABLE)
        ...
        Public Function Populate_Loan_Fee_Record(ByVal mId As Integer, ByVal trm As Integer, ByVal intTrm As Integer, ByVal prn As Double) As DataTable
            Dim clsDataAccess As New DataAccess.DataAccess(gConnStringFileName)
            Dim strSql As String
            Dim dtListView As DataTable
            Try
                With clsDataAccess
                    dtListView = New DataTable
                    strSql = "CALL spLoanDeductionDetailFind(" & mId & "," & trm & "," & intTrm & "," & prn & ");"
        ...
        Private Sub Build_String_Before_Saving()
            ...
            If IsNothing(colLoanApplicationSignatory) = False Then
                For Each clsLoanApplicationSignatory In colLoanApplicationSignatory
                    ...
                    & "|" & CStr(clsLoanApplicationSignatory._signatoryPosition) _
                    & "|" & CStr(clsLoanApplicationSignatory._signedBy) & "|"
                Next
            End If
