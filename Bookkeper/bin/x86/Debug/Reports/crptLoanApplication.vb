...
Public Class crptLoanApplication
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crptLoanApplication.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bookkeper.crptLoanApplication.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptLoanApplication
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptLoanApplication = New crptLoanApplication
        rpt.Site = Me.Site
        Return rpt
    End Function
