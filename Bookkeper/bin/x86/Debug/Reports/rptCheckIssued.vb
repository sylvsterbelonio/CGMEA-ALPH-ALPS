...
Public Class rptCheckIssued
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bookkeper.rptCheckIssued.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCheckIssued
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCheckIssued = New rptCheckIssued
        rpt.Site = Me.Site
        Return rpt
    End Function
