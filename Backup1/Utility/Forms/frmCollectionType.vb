...
#Region "frmCollectionType Variable Declaration"
    ...
    Private WithEvents frmFinder As frmCollectionTypeFinder
...
#Region "frmCollectionType Main Form Private Sub"

    Private Sub frmCollectionType_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        clsCommon.Set_Toolbar_Tooltips(Me.tbrMainForm)
        Me.Cursor = WaitCursor
        Initialize_Form()
        If State = EDIT_STATE Or State = VIEW_STATE Then
            clsCollectionType.Init_Flag = RecordId
            clsCollectionType.Selected_Record()
            Assign_Data()
        End If
        Me.Cursor = Arrow
    End Sub

    Private Sub frmCollectionType_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    ...
    Private Sub frmCollectionType_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Disposed
        Disposed_Class()
    End Sub

    Private Sub frmCollectionType_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtCollectionDescription.KeyPress
...
#Region "frmCollectionType ToolBar Private Sub"
...
find_rec:
                    If Not blnUseFinder Then
                        Dim frmFinder As frmCollectionTypeFinder
                        frmTitle = "Collection Type Finder"
                        If clsCommon.CheckIfRecordIsLoaded(Me.ParentForm, frmTitle) Then
                        ...
                        Else
                            frmFinder = New frmCollectionTypeFinder
                            With frmFinder
                                .Type_Id = 0
...
save_rec:
                    If clsCommon.Required_Validation_List(ColRequired) Then
                        ...
                        With clsCollectionType
                            ...
                            ._typeCode = Trim(txtCollectionCode.Text)
                            If chkLoanRequired.Checked = True Then
                                ._loanRequired = 1
                            Else
                                ._loanRequired = 0
                            End If
                            ._typeDescription = Trim(txtCollectionDescription.Text)
                            ...
                            If .Save_Record() Then
                                ...
                                Me.Text = "Collection Type - " & txtCollectionName.Text & " (" & txtCollectionCode.Text & ")"
...
#Region "frmCollectionType User Defined Private Sub"
    ...
    Private Sub Assign_Data()
        With clsCollectionType
            ...
            txtCollectionCode.Text = ._typeCode
            If ._loanRequired = 1 Then
                chkLoanRequired.Checked = True
            Else
                chkLoanRequired.Checked = False
            End If
            txtCollectionDescription.Text = ._typeDescription
    ...
    Private Sub Disposed_Class()
        clsCollectionType = Nothing
        clsCommon = Nothing
        ColCollectionType = Nothing
        ColRequired = Nothing
    End Sub
    ...
    Public Sub Set_Form_State()
        ...
        If State = "View" Then
            ...
            lblCollectionCode.Text = "Collection Code"
        Else
            lblCollectionName.Text = "Collection Name *"
            lblCollectionCode.Text = "Collection Code *"
        End If
    ...
    Private Sub Event_Handler(ByVal strMessage As String, ByVal blnSuccessFl As Boolean) Handles clsCollectionType.MsgArrival, clsCommon.MsgArrival
        Me.Cursor = Arrow
    ...
    Private Sub Set_Required_Tags()
        ...
        txtCollectionCode.Tag = "Collection Type Code"
    End Sub

    Private Sub Set_Max_Length()
        txtCollectionName.MaxLength = 255
        txtCollectionCode.MaxLength = 45
        txtCollectionDescription.MaxLength = 2000
    End Sub
