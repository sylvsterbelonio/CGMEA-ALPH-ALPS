...
save_rec:
                    If clsCommon.Required_Validation_List(ColRequired) Then
                        ...
                        With clsWithdrawal
                            ...
                            ._capitalAmount = Format(txtCapitallAmount.Text, "Standard")
                            ._interestIncome = Format(txtInterestIncome.Text, "Standard")
                            ._netProceeds = Format(txtNetProceeds.Text, "Standard")
...
#Region "frmMemberWithdrawal User Defined Private Sub"
    ...
    Private Sub Set_Default_Values()
        Try
            ...
            txtMemberId.Text = ""
            txtDepartment.Text = ""
            txtCurrentShare.Text = ""
            txtVoucherNo.Text = ""
            txtCheckNo.Text = ""
            txtCapitallAmount.Text = "0.00"
    ...
    Private Sub Assign_Data()
        With clsWithdrawal
            ...
            txtCapitallAmount.Text = Format(._capitalAmount, "Standard")
            txtInterestIncome.Text = Format(._interestIncome, "Standard")
            txtNetProceeds.Text = Format(._netProceeds, "Standard")
            txtRemarks.Text = ._withdrawalRemarks
            txtReceivedBy.Text = ._receivedBy
        ...
        Me.Text = "Member Drawings - " & Trim(txtMemberName.Text)
    End Sub
