...
Add_Rec:
                    ...
                    If LCase(Me.Tag) = "member drawings" Then
                        Dim NwfrmMemberWithdrawal As New frmMemberWithdrawal
                        frmTitle = "Member Drawings"
                ...
                Case "&view", "&edit"
                    ...
                    If clsWithdrawal.Selected_Record() Then
                        If LCase(Me.Tag) = "member drawings" Then
                            ...
                            frmTitle = "Member Drawings - [" & clsWithdrawal._voucherNo & "]"
...
Use_Rec:
    ...
    Private Sub Initialize_All()
        Me.Tag = "Member Drawings"
        Me.Text = "Member Drawings Finder"
