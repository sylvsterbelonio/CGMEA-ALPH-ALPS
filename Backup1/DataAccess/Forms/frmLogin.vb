...
Public Class frmLogin
    ...
    Public gifLogo As Drawing.Image = MyTemplates.clsSkin.getLogo
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        MyTemplates.clsSkin.setTemplate(Me)
        Dim hMenu As IntPtr
        ...
        Else
            ...
            If blnExist And (clsLogin.Online_Fl = 0) And (clsLogin.Active_Fl = 1) Then
                ...
                If LCase(btnLogin.Text) = "&ok" Then
                    ...
                    Dim myWelcomeScr As New PowerNET8.myWelcomeScreen
                    myWelcomeScr.run(MyTemplates.clsSkin.getLogo, Drawing.Color.Beige, Drawing.Color.Black, 0.85)
                End If
