...
Public Class frmMemberRetireFinder
    Inherits System.Windows.Forms.Form

#Region "frmMemberRetireFinder Variable Declaration"

    Private colMember As New Collection
    Private colButton As New Collection
    Private tooltipMemberRetire As New ToolTip
...
#Region "frmMemberRetireFinder Form Sub"

    Private Sub frmMemberRetireFinder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Cursor = WaitCursor
        Initialize_All()
        Me.Cursor = Arrow
    End Sub

    Private Sub frmMemberRetireFinder_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        If Use_Record_State = USE_STATE Then
            btnEdit.PerformClick()
        End If
    End Sub

    Private Sub frmMemberRetireFinder_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress, txtLGUName.KeyPress, txtDepartmentName.KeyPress, txtMemberName.KeyPress, txtMemberNo.KeyPress ', udgFinder.KeyPress
...
#Region "frmMemberRetireFinder User Defined Private Sub"
...
Add_Rec:
                    ...
                    If Use_Record_State = USE_STATE Then
                        NwfrmMemberRetire = New frmMemberRetire
                        With NwfrmMemberRetire
                            .State = Current_State
                            .blnUseFinder = True
                            .RecordId = 0
                ...
                Case "&view", "&edit"
                    ...
                    clsMemberRetire.Init_Flag = intManagementId
                    If clsMemberRetire.Selected_Record() Then
                        Dim NwfrmMemberRetire As frmMemberRetire
                        clsMember.Init_Flag = clsMemberRetire.Member_Id
                        clsMember.Selected_Record()
                        frmTitle = "Member Retire - " & clsMember.Last_Name & IIf(Len(clsMember._suffixName) > 0, " " & clsMember._suffixName, "") & ", " & clsMember.First_Name & IIf(Len(clsMember.Middle_Name) > 0, " " & clsMember.Middle_Name, "")
...
Use_Rec:
    ...
    Private Sub Initialize_All()
        ...
        Me.tooltipMemberRetire = clsCommon.SetUp_ToolTip_Finder(colButton)
        Create_Context_Menu()
    End Sub

    Private Sub Event_Handler(ByVal strMessage As String, ByVal blnSuccessfl As Boolean) Handles clsMemberRetire.MsgArrival
        Me.Cursor = Arrow
...
#Region "frmMemberRetireFinder DataGridView Private Sub"
...
#Region "frmMemberRetireFinder Protected Overrides Sub"
