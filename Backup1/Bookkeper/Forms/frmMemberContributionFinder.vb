...
Public Class frmMemberContributionFinder

    Inherits System.Windows.Forms.Form

#Region "frmMembersContributionFinder Variable Declaration"

    Private colMemberContribution As New Collection
    Private colButton As New Collection
    Private tooltipMemberContribution As New ToolTip
...
#Region "frmMembersContributionFinder Public Property Variable Declaration"
...
#Region "frmMembersContributionFinder Form Sub"

    Private Sub frmMerbersContributionFinder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Cursor = WaitCursor
        Initialize_All()

        'If LCase(Me.Tag) = "member information and accounts" Then
        'btnAdd.Visible = False
        ' btnEdit.Visible = False
        'ElseIf LCase(Me.Tag) = "member contribution" Then
        btnAdd.Visible = False
        btnEdit.Visible = False
        'End If
        Me.Cursor = Arrow
    ...
    Private Sub frmMerbersContributionFinder_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        If Use_Record_State = USE_STATE Then
            btnEdit.PerformClick()
        End If
    End Sub

    Private Sub frmMerbersContributionFinder_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress, txtDepartmentName.KeyPress, txtMemberName.KeyPress, txtMemberNo.KeyPress
...
#Region "frmMembersContributionFinder User Defined Private Sub"
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click, dgvFinder.DoubleClick, btnEdit.Click, btnAdd.Click
...
Add_Rec:
                    ...
                    Dim NwfrmMerberContribution As New frmMemberContribution
                    frmTitle = "Member Information and Accounts"

                    If Use_Record_State = USE_STATE Then
                        NwfrmMerberContribution = New frmMemberContribution
                        With NwfrmMerberContribution
                            .State = Current_State
                            .blnUseFinder = True
                            .RecordId = 0
                    ...
                    Else
                        If clsCommon.CheckIfRecordIsLoaded(Me.ParentForm, frmTitle) Then
                            NwfrmMerberContribution = clsCommon.GetRecordChildForm(Me.ParentForm, frmTitle)
                            NwfrmMerberContribution.Activate()
                        Else
                            NwfrmMerberContribution = New frmMemberContribution
                            With NwfrmMerberContribution
                                .State = Current_State
                ...
                Case "&view", "&edit"
                    ...
                    clsMemberContribution.Init_Flag = intMemberId
                    If clsMemberContribution.Selected_Record() Then
                        Dim NwfrmMemberContribution As frmMemberContribution
                        frmTitle = "Member - " & clsMemberContribution.Last_Name & IIf(Len(clsMemberContribution._suffixName) > 0, " " & clsMemberContribution._suffixName, "") & ", " & clsMemberContribution.First_Name & IIf(Len(clsMemberContribution.Middle_Name) > 0, " " & clsMemberContribution.Middle_Name, "") & " - [" & clsMemberContribution.Department_Name & "]"

                        If clsCommon.CheckIfRecordIsLoaded(Me.ParentForm, frmTitle) Then
                            NwfrmMemberContribution = clsCommon.GetRecordChildForm(Me.ParentForm, frmTitle)
                            NwfrmMemberContribution.Activate()
                        Else
                            NwfrmMemberContribution = New frmMemberContribution
                            With NwfrmMemberContribution
                                .State = Current_State
...
Use_Rec:
    ...
    Private Sub Clear_All_Controls()
        colMemberContribution = New Collection
    ...
    Private Sub Initialize_All()
        ...
        Me.tooltipMemberContribution = clsCommon.SetUp_ToolTip_Finder(colButton)
        Create_Context_Menu()
    End Sub

    Private Sub Event_Handler(ByVal strMessage As String, ByVal blnSuccessfl As Boolean) Handles clsMemberContribution.MsgArrival
        Me.Cursor = Arrow
...
#Region "frmMembersContributionFinder DataGridView Private Sub"
...
#Region "frmMembersContributionFinder Protected Overrides Sub"
