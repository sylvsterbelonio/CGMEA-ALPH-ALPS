...
#Region "Class Withdrawal Public Functions"
        ...
        Public Function Save_Record() As Boolean
            Try
                ...
                Save_Record = True
                strSql = "CALL spWithdrawalSave(" & withdrawalId & "," & memberId & ",'" & receivedBy & "','" & VoucherNo & "','" & WithdrawnDate & "'," & CapitalAmount & ",'" & withdrawalRemarks & "'," & updatedBy & ",'" & updatedDt & "');"
            ...
            Try
                ...
                With clsDataAccess
                    ...
                    For Each myRow1 In dtSelectedRecord.Rows
                        ...
                        Me.withdrawalRemarks = Trim(myRow1("remarks").ToString)
