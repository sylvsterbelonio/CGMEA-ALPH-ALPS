Module modPublics
    ...
    Public Const MSGBOX_CANCEL_OR_DELETE_CONFIRMATION = "Are you sure you want to cancel / delete this record? Click 'YES' to cancel or 'NO' to delete record. Otherwise click 'CANCEL' to exit this cancel / delete routine without saving changes."
