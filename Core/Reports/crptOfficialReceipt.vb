...
Public Class crptOfficialReceipt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crptOfficialReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Core.crptOfficialReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptOfficialReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptOfficialReceipt = New crptOfficialReceipt
        rpt.Site = Me.Site
        Return rpt
    End Function
