...
Public Class frmMemberInfoAndAccountsFinder

    Inherits System.Windows.Forms.Form

#Region "frmMembersInfoAndAccountsFinder Variable Declaration"

    Private colMembersInfoAndAccounts As New Collection
    Private colButton As New Collection
    Private tooltipMembersInfoAndAccounts As New ToolTip
...
#Region "frmMembersInfoAndAccountsFinder Public Property Variable Declaration"
...
#Region "frmMembersInfoAndAccountsFinder Form Sub"

    Private Sub frmMerbersInfoAndAccountsFinder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Cursor = WaitCursor
        Initialize_All()
        Me.Cursor = Arrow
    End Sub

    Private Sub frmMerbersInfoAndAccountsFinder_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        If Use_Record_State = USE_STATE Then
            btnEdit.PerformClick()
        End If
    End Sub

    Private Sub frmMerbersInfoAndAccountsFinder_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress, txtDepartmentName.KeyPress, txtMemberName.KeyPress, txtMemberNo.KeyPress
...
#Region "frmMembersInfoAndAccountsFinder User Defined Private Sub"
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click, dgvFinder.DoubleClick
...
Add_Rec:
                    ...
                    Dim NwfrmMerberInfoAndAccounts As New frmMemberInfoAndAccounts
                    frmTitle = "Member Information and Accounts"

                    If Use_Record_State = USE_STATE Then
                        NwfrmMerberInfoAndAccounts = New frmMemberInfoAndAccounts
                        With NwfrmMerberInfoAndAccounts
                            .ClearImage()
                            .State = Current_State
                            .blnUseFinder = True
                            .RecordId = 0
                    ...
                    Else
                        If clsCommon.CheckIfRecordIsLoaded(Me.ParentForm, frmTitle) Then
                            NwfrmMerberInfoAndAccounts = clsCommon.GetRecordChildForm(Me.ParentForm, frmTitle)
                            NwfrmMerberInfoAndAccounts.Activate()
                        Else
                            NwfrmMerberInfoAndAccounts = New frmMemberInfoAndAccounts
                            With NwfrmMerberInfoAndAccounts
                                .ClearImage()
                ...
                Case "&view", "&edit"
                    ...
                    clsMemberInfoAndAccounts.Init_Flag = intMemberId
                    If clsMemberInfoAndAccounts.Selected_Record() Then
                        Dim NwfrmMemberInfoAndAccounts As frmMemberInfoAndAccounts
                        frmTitle = "Member - " & clsMemberInfoAndAccounts.Last_Name & IIf(Len(clsMemberInfoAndAccounts._suffixName) > 0, " " & clsMemberInfoAndAccounts._suffixName, "") & ", " & clsMemberInfoAndAccounts.First_Name & IIf(Len(clsMemberInfoAndAccounts.Middle_Name) > 0, " " & clsMemberInfoAndAccounts.Middle_Name, "") & " (" & clsMemberInfoAndAccounts.Job_Description & ") - [" & clsMemberInfoAndAccounts.Department_Name & "]"

                        If clsCommon.CheckIfRecordIsLoaded(Me.ParentForm, frmTitle) Then
                            NwfrmMemberInfoAndAccounts = clsCommon.GetRecordChildForm(Me.ParentForm, frmTitle)
                            NwfrmMemberInfoAndAccounts.Activate()
                        Else
                            NwfrmMemberInfoAndAccounts = New frmMemberInfoAndAccounts
                            With NwfrmMemberInfoAndAccounts
                                .State = Current_State
...
Use_Rec:
    ...
    Private Sub Clear_All_Controls()
        colMembersInfoAndAccounts = New Collection
        With colMembersInfoAndAccounts
            .Add(txtMemberName)
            .Add(txtMemberNo)
            .Add(txtDepartmentName)
        End With
        clsCommon.ClearControls(colMembersInfoAndAccounts)
    End Sub
    ...
    Private Sub Initialize_All()
        ...
        Me.tooltipMembersInfoAndAccounts = clsCommon.SetUp_ToolTip_Finder(colButton)
        Create_Context_Menu()
        btnAdd.Visible = False
        btnEdit.Visible = False
    End Sub

    Private Sub Event_Handler(ByVal strMessage As String, ByVal blnSuccessfl As Boolean) Handles clsMemberInfoAndAccounts.MsgArrival
        Me.Cursor = Arrow
...
#Region "frmMembersInfoAndAccountsFinder DataGridView Private Sub"
...
#Region "frmMembersInfoAndAccountsFinder Protected Overrides Sub"
