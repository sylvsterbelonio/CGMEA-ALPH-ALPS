...
#Region "Class Main Variable Declaration"
...
#Region "Class Main Public Procedures"

        Public Sub PopulateMainMenu()
            Dim sqlStmt As String

            Try
                sqlStmt = "CALL spMainMenuGet(" & CStr(RoleId) & ");"
        ...
        Public Sub CheckIfMenuHasChild()
            ...
            Try
                sqlStmt = "CALL spMainMenuGetChildCount(" & CStr(ParentId) & "," & CStr(RoleId) & ");"
        ...
        Public Sub PopulateSubMenu()
            ...
            Try
                sqlStmt = "CALL spSubMenuGet(" & CStr(ParentId) & "," & CStr(RoleId) & ");"
        ...
        Public Sub PopulateToolBar()
            Dim sqlStmt As String

            Try
                sqlStmt = "CALL spToolBarGet(" & CStr(RoleId) & ");"
                dtToolBar = clsDataAccess.ExecuteQuery(sqlStmt, True, RETURN_TYPE_DATASET)
        ...
        Public Sub SystemLogSave()
            Dim sqlStmt As String

            Try
                sqlStmt = "CALL spSystemLogSave('" & intLogType & "','" & intLogDetail & "'," & intUserID & ");"
