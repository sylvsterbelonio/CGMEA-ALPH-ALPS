...
Public Class frmLoanApplicationApprovalFinder
    Inherits System.Windows.Forms.Form

#Region "frmLoanApplicationApprovalFinder Variable Declaration"

    Private colLoanApplication As New Collection
    Private colButton As New Collection
    Private tooltipLoanApplicationApproval As New ToolTip
...
#Region "frmLoanApplicationApprovalFinder Public Property Variable Declaration"
...
#Region "frmLoanApplicationApprovalFinder Form Sub"

    Private Sub frmLoanApplicationApprovalFinder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmLoanApplicationApprovalFinder_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress, txtMemberName.KeyPress, txtMemberNo.KeyPress, txtLoanNo.KeyPress
...
#Region "frmLoanApplicationApprovalFinder User Defined Private Sub"
    ...
    Private Sub Initialize_All()
        ...
        Me.tooltipLoanApplicationApproval = clsCommon.SetUp_ToolTip_Finder(colButton)
        Initialize_AutoComplete()
    End Sub

    Private Sub Event_Handler(ByVal strMessage As String, ByVal blnSuccessfl As Boolean) Handles clsLoanApplicationApproval.MsgArrival
        Me.Cursor = Arrow
...
#Region "frmLoanApplicationApprovalFinder DataGridView Private Sub"
    ...
    Private Sub dgvFinder_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvFinder.SelectionChanged
        If dgvFinder.SelectedRows.Count > 0 Then
            intLoanId = CInt(dgvFinder.SelectedRows(0).Cells(0).Value)
            loanStatus = CStr(dgvFinder.SelectedRows(0).Cells(10).Value)
            refId = CStr(dgvFinder.SelectedRows(0).Cells(12).Value)
        End If
    End Sub
...
#Region "frmLoanApplicationApprovalFinder Protected Overrides Sub"
...
#End Region
    ...
    Private Sub ApproveLoanToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ApproveLoanToolStripMenuItem.Click, EditApproveLoanToolStripMenuItem.Click, ViewLoanApplicationToolStripMenuItem.Click
        ...
        Select Case LCase(sender.Text)
            Case "approve loan"
                ...
                If Use_Record_State = USE_STATE Then
                    NwfrmLoanApplicationApproval = New frmLoanApplicationApproval
                    With NwfrmLoanApplicationApproval
                        .State = Current_State
                        .blnUseFinder = True
                        .RecordId = 0
                ...
                Else
                    ...
                    Else
                        ...
                        With NwfrmLoanApplicationApproval
                            .State = Current_State
                            .RecordId = 0
                            .approvalLoanId = CInt(dgvFinder.SelectedRows(0).Cells(0).Value)
                            .MdiParent = Me.MdiParent
                            .Show()
                        End With
                    End If
                End If
            Case "edit approved loan"
                Current_State = VIEW_STATE
                clsLoanApplicationApproval.Init_Flag = refId
                If clsLoanApplicationApproval.Selected_Record() Then
                    Dim NwfrmLoanApplicationApproval As frmLoanApplicationApproval
                    frmTitle = "Loan Application Approval - " & clsLoanApplicationApproval._memberName
                    ...
                    Else
                        ...
                        With NwfrmLoanApplicationApproval
                            ...
                            If Not LCase(sender.Name) = "ViewLoanApplicationToolStripMenuItem" Then
                                If Not loanStatus = "FOR RELEASING" Then
                                ...
                                Else
                                    ...
                                    With frmLoginOverrideForm
                                        If .ShowDialog = Windows.Forms.DialogResult.OK Then
                                            NwfrmLoanApplicationApproval.State = EDIT_STATE
                                            NwfrmLoanApplicationApproval.Set_Form_State()
                                        End If
                                    End With
                                End If
                            End If
