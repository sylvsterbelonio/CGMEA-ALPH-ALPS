...
Public Class frmMemberReplaceFinder
    Inherits System.Windows.Forms.Form

#Region "frmMemberReplaceFinder Variable Declaration"

    Private colMember As New Collection
    Private colButton As New Collection
    Private tooltipMemberReplace As New ToolTip
...
#Region "frmMemberReplaceFinder Form Sub"

    Private Sub frmMemberReplaceFinder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Cursor = WaitCursor
        Initialize_All()
        Me.Cursor = Arrow
    End Sub

    Private Sub frmMemberReplaceFinder_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        If Use_Record_State = USE_STATE Then
            btnEdit.PerformClick()
        End If
    End Sub

    Private Sub frmMemberReplaceFinder_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress, txtLGUName.KeyPress, txtDepartmentName.KeyPress, txtMemberName.KeyPress, txtMemberNo.KeyPress ', udgFinder.KeyPress
...
#Region "frmMemberReplaceFinder User Defined Private Sub"
...
Add_Rec:
                    ...
                    If Use_Record_State = USE_STATE Then
                        NwfrmMemberReplace = New frmMemberReplace
                        With NwfrmMemberReplace
                            .State = Current_State
                            .blnUseFinder = True
                            .RecordId = 0
                ...
                Case "&view", "&edit"
                    ...
                    clsMemberReplace.Init_Flag = intManagementId
                    If clsMemberReplace.Selected_Record() Then
                        Dim NwfrmMemberReplace As frmMemberReplace
                        clsMember.Init_Flag = clsMemberReplace.Member_Id
                        clsMember.Selected_Record()
                        frmTitle = "Member Replace - " & clsMember.Last_Name & IIf(Len(clsMember._suffixName) > 0, " " & clsMember._suffixName, "") & ", " & clsMember.First_Name & IIf(Len(clsMember.Middle_Name) > 0, " " & clsMember.Middle_Name, "")
...
Use_Rec:
    ...
    Private Sub Initialize_All()
        ...
        Me.tooltipMemberReplace = clsCommon.SetUp_ToolTip_Finder(colButton)
        Create_Context_Menu()
    End Sub

    Private Sub Event_Handler(ByVal strMessage As String, ByVal blnSuccessfl As Boolean) Handles clsMemberReplace.MsgArrival
        Me.Cursor = Arrow
...
#Region "frmMemberReplaceFinder DataGridView Private Sub"
...
#Region "frmMemberReplaceFinder Protected Overrides Sub"
