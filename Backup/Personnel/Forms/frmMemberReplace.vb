...
Public Class frmMemberReplace
    Inherits System.Windows.Forms.Form

    Private WithEvents clsCommon As New Common.Common
    Private WithEvents clsPermission As New DataAccess.Permission(gConnStringFileName)
    Private WithEvents clsMemberReplace As New MemberManagement.MemberManagement
    ...
    Private WithEvents frmFinder As frmMemberReplaceFinder
    ...
    Private ColMemberReplace As New Collection
...
#Region "frmMemberReplace Main Form Private Sub"

    Private Sub frmMemberReplace_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        clsCommon.Set_Toolbar_Tooltips(Me.tbrMainForm)
        Me.Cursor = WaitCursor
        Initialize_Form()
        If State = EDIT_STATE Or State = VIEW_STATE Then
            clsMemberReplace.Init_Flag = RecordId
            clsMemberReplace.Selected_Record()
            Assign_Data()
        End If
        Me.Cursor = Arrow
    End Sub

    Private Sub frmMemberReplace_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    ...
    Private Sub frmMemberReplace_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Disposed
        Disposed_Class()
    End Sub

    Private Sub frmMemberReplace_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress, txtMemberId.KeyPress, txtMemberIdReplacement.KeyPress, txtMemberName.KeyPress, txtMemberNameReplacement.KeyPress, txtRemarks.KeyPress, dtpManagementDt.KeyPress
...
#Region "frmMemberReplace ToolBar Private Sub"
    ...
    Private Sub tbrMainForm_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles tbrMainForm.ButtonClick
        If TypeOf (sender) Is ToolBar Then
            ...
            Select Case e.Button.ImageIndex()
                Case 0 'add
add_rec:
                    Dim NwfrmMemberReplace As New frmMemberReplace
                    frmTitle = "Member Replace"
                    If blnUseFinder Then
                        State = ADD_STATE
                        clsCommon.ClearControls(ColMemberReplace)
                        Set_Form_State()
                        RecordId = 0
                    ...
                    Else
                        If clsCommon.CheckIfRecordIsLoaded(Me.ParentForm, frmTitle) Then
                            NwfrmMemberReplace = clsCommon.GetRecordChildForm(Me.ParentForm, frmTitle)
                            NwfrmMemberReplace.Activate()
                        Else
                            State = ADD_STATE
                            clsCommon.ClearControls(ColMemberReplace)
                            Set_Form_State()
...
find_rec:
                    If Not blnUseFinder Then
                        Dim frmFinder As frmMemberReplaceFinder
                        frmTitle = "Member Replace Finder"
                        If clsCommon.CheckIfRecordIsLoaded(Me.ParentForm, frmTitle) Then
                        ...
                        Else
                            frmFinder = New frmMemberReplaceFinder
                            With frmFinder
                                .Management_Id = 0
...
save_rec:
                    If clsCommon.Required_Validation_List(ColRequired) Then
                        ...
                        With clsMemberReplace
                            ...
                            .ToDepartment_Id = 0
                            .To_Designation = ""
                            .ToAppointment_Status = ""
                            .ForMember_Id = IIf(Len(txtMemberIdReplacement.Text) = 0, 0, Val(txtMemberIdReplacement.Text.Replace(",", "")))
                            ...
                            If .Save_Record() Then
                                ...
                                clsMember.Init_Flag = clsMemberReplace.Member_Id
                                clsMember.Selected_Record()
                                Me.Text = "Member Replace - " & clsMember.Last_Name & IIf(Len(clsMember._suffixName) > 0, " " & clsMember._suffixName, "") & ", " & clsMember.First_Name & IIf(Len(clsMember.Middle_Name) > 0, " " & clsMember.Middle_Name, "")
...
#Region "frmMemberReplace User Defined Private Sub"
    ...
    Private Sub Define_Display()
        ...
        With ColDisplay
            ...
            .Add(txtMemberId)
            .Add(txtMemberIdReplacement)
            .Add(txtMemberName)
            .Add(txtMemberNameReplacement)
            .Add(txtRemarks)
    ...
    Private Sub Define_Pipe_Fields()
        ...
        With ColPipe
            ...
            .Add(Me.lblMemberNameReplacement)
        End With
    End Sub
    ...
    Private Sub Assign_Data()
        With clsMemberReplace
            ...
            txtMemberIdReplacement.Text = .ForMember_Id
        ...
        'clsDepartment.Init_Flag = clsMemberReplace.ToDepartment_Id
        'clsDepartment.Selected_Record()
        'txtDepartmentName.Text = clsDepartment.Department_Name

        If clsMemberReplace.ForMember_Id > 0 Then
            clsMember.Init_Flag = clsMemberReplace.ForMember_Id
            clsMember.Selected_Record()
            txtMemberNameReplacement.Text = clsMember.Last_Name & IIf(Len(clsMember._suffixName) > 0, " " & clsMember._suffixName, "") & ", " & clsMember.First_Name & IIf(Len(clsMember.Middle_Name) > 0, " " & clsMember.Middle_Name, "")
        End If
    End Sub
    ...
    Private Sub Disposed_Class()
        clsMemberReplace = Nothing
        clsCommon = Nothing
        ColDisplay = Nothing
        ColRequired = Nothing
        ColMemberReplace = Nothing
    End Sub
    ...
    Private Sub Event_Handler(ByVal strMessage As String, ByVal blnSuccessFl As Boolean) Handles clsMemberReplace.MsgArrival, clsCommon.MsgArrival
        Me.Cursor = Arrow
    ...
    Private Sub Set_Required_Tags()
        txtMemberName.Tag = "Member Name to Replace"
        txtMemberNameReplacement.Tag = "Replacement Member Name"
    ...
    Private Sub txtMemberName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtMemberName.KeyPress, txtMemberNameReplacement.KeyPress
    ...
    Private Sub txtMemberNameReplacement_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtMemberNameReplacement.KeyUp
        If sender Is Nothing OrElse e Is Nothing Then
            Return
        End If
        If State <> VIEW_STATE Then
            clsCommon.Delete_TxtBox_Value(txtMemberIdReplacement, e)
            clsCommon.Delete_TxtBox_Value(txtMemberNameReplacement, e)
    ...
    Private Sub txtMemberName_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles txtMemberName.MouseUp, txtMemberNameReplacement.MouseUp
        If sender Is Nothing OrElse e Is Nothing Then
            Return
        End If
...
#End Region
    ...
    Private Sub lblMemberNameReplacement_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblMemberNameReplacement.Click
        Try
    ...
    Private Sub frmUseForMemberFinder_Use_Clicked(ByVal Record_Id As Integer, ByVal Record_Name As String, ByVal Record_Cd As String) Handles frmUseForMemberFinder.Use_Clicked
        ...
        With clsMember
            ...
            txtMemberIdReplacement.Text = .Member_Id
            txtMemberNameReplacement.Text = .Last_Name & IIf(Len(._suffixName) > 0, " " & ._suffixName, "") & ", " & .First_Name & IIf(Len(.Middle_Name) > 0, " " & .Middle_Name, "")
        End With
    End Sub
