...
Public Class frmPaymentFinder
    Inherits System.Windows.Forms.Form

#Region "frmPaymentFinder Variable Declaration"
...
#Region "frmPaymentFinder Form Sub"

    Private Sub frmPaymentFinder_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    'Private Sub frmPaymentFinder_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
    '    If Use_Record_State = USE_STATE Then
...
#Region "frmPaymentFinder User Defined Private Sub"
...
Add_Rec:
                ...
                Case "&view", "&edit"
                    ...
                    If clsPayment.Selected_Record() Then
                        If LCase(Me.Tag) = "deposits, loans and miscellaneous" Then
                            Dim NwfrmPayment As frmPayment
                            frmTitle = "Deposits, Loans and Miscellaneous Payment - [" & clsPayment.OR_No & "]"
                                        ...
                                        Else
                                            ...
                                            With frmLoginOverride
                                                If .ShowDialog = Windows.Forms.DialogResult.OK Then
                                                    NwfrmPayment.State = EDIT_STATE
                                                    NwfrmPayment.Set_Form_State()
                                                End If
                                            End With
                                        End If
                                    End If
...
Use_Rec:
    ...
    Private Sub Initialize_Grid()
        ...
        With clsPayment
            ...
            If dtpORDate.Checked = True Then
                ...
                If btnDaily.Checked = True Then
                    .Date_Type = 1
                ElseIf btnMonthly.Checked = True Then
                    .Date_Type = 2
                End If
            Else
                .CritOR_Dt = ""
    ...
    Private Sub Search_Crit()
        ...
        With clsPayment
            ...
            .CritOR_AmountTo = CDbl(IIf((Len(txtORAmountTo.Text.Replace(",", "")) = 0), 0, Val(txtORAmountTo.Text.Replace(",", ""))))
            .CritCancel_Fl = intCancelFl
            .CritReference_Id = intReferenceId
    ...
    Private Sub Initialize_All()
        ...
        If LCase(Me.Tag) = "deposits, loans and miscellaneous" Then
            intReferenceId = 0
        ElseIf LCase(Me.Tag) = "loan payments" Then
            intReferenceId = 1
        End If
...
#Region "frmPaymentFinder DataGridView Private Sub"
...
#Region "frmPaymentFinder Protected Overrides Sub"
...
#End Region
    ...
    Private Sub txtORAmount_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtORAmount.LostFocus

    End Sub

    Private Sub txtORAmount_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtORAmount.TextChanged
        txtORAmountTo.Text = CDbl(txtORAmount.Text) + 999
    End Sub
End Class